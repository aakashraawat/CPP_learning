// Call by Address :use pointers to get the location (address)ie It can  access the variable the main function and can affect the parameters value as we are using pointers
...
///        Formal paramters
void swap (int *a, int *b){// a is pointer to x and same for y.
    cout << a << " and " << b <<endl;
